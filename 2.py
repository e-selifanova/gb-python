...
class Road:
    ...
    def mass(self):
        length_mass = self._length
        width_mass = self._width
        weight_mass = self.weight
        depth_mass = self.depth
        total_mass = length_mass * width_mass * weight_mass * depth_mass / 1000
        return print(f"Масса асфальта: {total_mass} т.")
